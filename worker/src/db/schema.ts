...
export type LogStream = (typeof logStreamEnum.enumValues)[number];
export type DeploymentStatus = (typeof deploymentStatusEnum.enumValues)[number];
export type BuildJobStatus = (typeof buildJobStatusEnum.enumValues)[number];
export type ProjectEnvTarget = (typeof projectEnvTargetEnum.enumValues)[number];
